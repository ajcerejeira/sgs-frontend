...
import { IonicPage, ViewController, NavParams, App, NavController, ToastController } from 'ionic-angular';
...
export class UserRegisterPage {
  ...
  createUser(){
    ...
    if(this.user.value['password']===this.user.value['confirmPassword']){
      ...
      this.http.post("https://sgs-backend.herokuapp.com/api/users", new_user)
      .subscribe(data => {
